...
//					tooltip.add(Component.translatable("jei.ftbquests.lootcrates.chance", ChatFormatting.GOLD + WeightedReward.chanceString(rewards.get(i).weight, crate.table.getTotalWeight(true))).withStyle(ChatFormatting.GRAY));
//					return;
//				}
//			}
//		}
