...
{
	public static final BlockGuiSupplier BLOCK = new BlockGuiSupplier(FTBQuests.MOD, 1)
	{
		@Override
		public Container getContainer(EntityPlayer player, TileEntity tileEntity)
		{
			return new ContainerQuestBlock(player, (TileQuest) tileEntity);
		}
		...
		{
			return new GuiQuestBlock((ContainerQuestBlock) container).getWrapper();
		}
	};
