 ...
 */
public class ItemChoiceLootcrate extends Item
{
	public static class Data implements ICapabilitySerializable<NBTTagCompound>
	{
		public final List<QuestReward> rewards = new ObjectArrayList<>();
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag)
	{
		...
		for (QuestReward reward : data.rewards)
		{
			tooltip.add(TextFormatting.GRAY + "  - " + reward.getDisplayName().getFormattedText());
		}
	}
}