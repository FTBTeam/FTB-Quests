...
public class IC2Integration
{
	...
	{
		event.getRegistry().register(FTBQuestsTasks.IC2_ENERGY = new TaskType(IC2EnergyTask::new).setRegistryName("ic2_energy").setIcon(Icon.getIcon(IC2EnergyTask.FULL_TEXTURE.toString()).combineWith(Icon.getIcon(IC2EnergyTask.EMPTY_TEXTURE.toString()))));
	}
}