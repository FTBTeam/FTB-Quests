...
### Fixed
* Fixed filename case-sensitivity issues with chapter and/or reward table .json5 files
...
### Fixed
* Deserialization error in the Location Task
...
* Clicking fluids in a fluid task now shows the recipes (if any) for that fluid in JEI/REI
  * FTB XMod Compat 26.1.2.3+ required

## [26.1.2.2]

### Fixed
* Fixed a bug in Observation task serialization
* Fixed image rotation values being interpreted wrongly (degrees -> radians conversion error)
...
### Fixed
* Fixed Random/Choice/Loot rewards not allowing a reward table to be configured
