...
### Fixed
* Fixed some quests with optional tasks autocompleting on login when they shouldn't be
...
### Fixed
* Fixed repeatable quest cooldowns not sync'ing to client when quest is repeatable due to chapter defaults
...
### Fixed
* Fixed a permission checking issue in a few network packet handlers
...
* Pressing F5 while in the quest GUI and in edit mode forces the `ftb_quests_theme.txt` theme file to be reloaded
