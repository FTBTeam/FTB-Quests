...
### Fixed
* Structure tasks crashing when a non-tag structures were selected for locating [#2028](https://github.com/FTBTeam/FTB-Mods-Issues/issues/2028)

## [2111.1.5]

### Fixed
* Biome tasks not working as it failed to lookup the available biomes [#2026](https://github.com/FTBTeam/FTB-Mods-Issues/issues/2026)
