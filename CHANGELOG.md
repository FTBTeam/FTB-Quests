...
### Fixed
* Fixed potential serious performance issue when crafting items with a very large quest book
* Fixed quests in "Always Invisible" chapters appearing in the quest search tool
* Fixed possible NPE in observation task (hard to reproduce, may be related to dimension switching)
