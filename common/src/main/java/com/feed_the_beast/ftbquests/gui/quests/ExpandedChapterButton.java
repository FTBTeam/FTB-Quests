 ...
 */
public class ExpandedChapterButton extends SimpleTextButton {
	public final QuestsScreen treeGui;
	public final Chapter chapter;
	public List<Component> description;

	public ExpandedChapterButton(Panel panel, Chapter c) {
		super(panel, c.getTitle(), c.getIcon());
		treeGui = (QuestsScreen) getGui();
		chapter = c;
	...
	public void onClicked(MouseButton button) {
		...
		if (treeGui.file.canEdit() && button.isRight()) {
			...
			QuestsScreen.addObjectMenuItems(contextMenu, treeGui, chapter);
