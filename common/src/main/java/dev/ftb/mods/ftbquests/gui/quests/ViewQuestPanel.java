...
public class ViewQuestPanel extends Panel {
	...
	private class GotoLinkedQuestButton extends SimpleTextButton {
		public GotoLinkedQuestButton() {
			super(ViewQuestPanel.this, Component.translatable("ftbquests.gui.goto_linked_quest", quest.chapter.getTitle().copy().withStyle(ChatFormatting.YELLOW)), ThemeProperties.LINK_ICON.get());
		}
	...
	public class PinViewQuestButton extends SimpleTextButton {
		public PinViewQuestButton() {
			super(ViewQuestPanel.this,
					Component.translatable(questScreen.file.self.pinnedQuests.contains(quest.id) ? "ftbquests.gui.unpin" : "ftbquests.gui.pin"),
	...
	public class CloseViewQuestButton extends SimpleTextButton {
		public CloseViewQuestButton() {
			super(ViewQuestPanel.this, Component.translatable("gui.close"), ThemeProperties.CLOSE_ICON.get(quest));
		}
