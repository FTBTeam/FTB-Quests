		...
		public void addMouseOverText(TooltipList list) {
			...
			if (object instanceof Quest quest) {
				...
				link.getQuest().ifPresent(quest -> {
					...
					list.add(new TranslatableComponent("ftbquests.gui.linked_quest_id", new TextComponent(quest.getCodeString()).withStyle(ChatFormatting.DARK_GRAY)).withStyle(ChatFormatting.GRAY));
					addObject(list, quest.chapter);
				});
