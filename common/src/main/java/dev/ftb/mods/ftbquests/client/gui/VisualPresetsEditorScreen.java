...
public class VisualPresetsEditorScreen extends AbstractButtonListScreen {
    ...
    private final EditableVisualPresets config;
    private final ConfigCallback callback;
    private int widestName = 40;
    private int widestShapeName = 40;

    public VisualPresetsEditorScreen(EditableVisualPresets config, ConfigCallback callback) {
        this.config = config;
    ...
    private class PresetTitle extends Panel {
        ...
        public void draw(GuiGraphicsExtractor graphics, Theme theme, int x, int y, int w, int h) {
            ...
            graphics.horizontalLine(x, x + w, y + h - 3, Color4I.GRAY.withAlpha(128).rgba());
        }
    }
    ...
    private class SizeButton extends SimpleTextButton {
        ...
        public void onClicked(MouseButton button) {
            EditableDouble config = new EditableDouble(0.1, 10.0);
    ...
    private class AddEditPresetOverlay extends ModalPanel {
        ...
        private void onAccepted(MouseButton mouseButton) {
            try {
                ...
                FTBQuestsClient.showErrorToast(Component.literal(e.getMessage()));
            }
        }
