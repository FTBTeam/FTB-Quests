...
public class QuestScreen extends BaseScreen {
	...
	public void addObjectMenuItems(List<ContextMenuItem> contextMenu, Runnable gui, QuestObjectBase object, Movable deletionFocus) {
		...
		contextMenu.add(new ContextMenuItem(new TranslatableComponent("selectServer.edit"),
		...
		if (object instanceof QuestLink link) {
			link.getQuest().ifPresent(quest -> {
				contextMenu.add(new ContextMenuItem(new TranslatableComponent("ftbquests.gui.edit_linked_quest"),
						ThemeProperties.EDIT_ICON.get(),
		...
		if (!subGroup.getValues().isEmpty()) {
			contextMenu.add(new ContextMenuItem(new TranslatableComponent("ftbquests.gui.copy_id.quick_properties"),
					Icons.SETTINGS,
		...
		if (object instanceof RandomReward rr && !QuestObjectBase.isNull(rr.getTable())) {
			contextMenu.add(new ContextMenuItem(new TranslatableComponent("ftbquests.reward_table.edit"),
					ThemeProperties.EDIT_ICON.get(),
		...
		contextMenu.add(new ContextMenuItem(new TranslatableComponent("ftbquests.gui.reset_progress"),
		...
		contextMenu.add(new ContextMenuItem(new TranslatableComponent("ftbquests.gui.complete_instantly"),
		...
		Component[] tooltip = object instanceof Quest ?
				new Component[] {
						new TextComponent(QuestObjectBase.getCodeString(object)),
						new TranslatableComponent("ftbquests.gui.copy_id.paste_hint").withStyle(ChatFormatting.GRAY)
				} :
				new Component[] {
						new TextComponent(QuestObjectBase.getCodeString(object))
				};
		contextMenu.add(new TooltipContextMenuItem(new TranslatableComponent("ftbquests.gui.copy_id"),
